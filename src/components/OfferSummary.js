      ...
      <Card.Body>
        <Card.Title>
          ...
          <span style={{ fontFamily: "Roboto Slab" }}>
            ...
            <svg width="24" height="24" viewBox="0 0 24 24" aria-label="sync">
            ...
            {props.offer.slices[0].destination.city_name})
          </span>
        </Card.Title>
      </Card.Body>
      <ListGroup className="list-group-flush">
        <ListGroupItem>
          <span style={{ fontFamily: "Roboto Slab" }}>Departing:</span>{" "}
          <span style={{ fontFamily: "Ubuntu" }}>
            {props.offer.slices[0].segments[0].departing_at}
          </span>
        </ListGroupItem>
        <ListGroupItem>
          <span style={{ fontFamily: "Roboto Slab" }}>Arriving:</span>{" "}
          <span style={{ fontFamily: "Ubuntu" }}>
            {props.offer.slices[0].segments[0].arriving_at}
          </span>
        </ListGroupItem>
        <ListGroupItem>
          <span style={{ fontFamily: "Roboto Slab" }}>Carrier:</span>{" "}
          <span style={{ fontFamily: "Ubuntu" }}>
